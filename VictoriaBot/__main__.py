...
from VictoriaBot.modules import ALL_MODULES
from VictoriaBot.modules.helper_funcs.chat_status import is_user_admin
from VictoriaBot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("VictoriaBot.modules." + module_name)
...
@run_async
def Victoria_about_callback(update, context):
    query = update.callback_query
    if query.data == "Victoria_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Victoria_back")
                 ]
                ]
            ),
        )
    elif query.data == "Victoria_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Victoria_about_callback, pattern=r"Victoria_")

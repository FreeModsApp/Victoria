...
import VictoriaBot.modules.sql.notes_sql as sql
from VictoriaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from VictoriaBot.__main__ import DATA_IMPORT
from VictoriaBot.modules.helper_funcs.chat_status import user_admin
from VictoriaBot.modules.helper_funcs.alternate import typing_action

# from VictoriaBot.modules.rules import get_rules
import VictoriaBot.modules.sql.rules_sql as rulessql

# from VictoriaBot.modules.sql import warns_sql as warnssql
import VictoriaBot.modules.sql.blacklist_sql as blacklistsql
from VictoriaBot.modules.sql import disable_sql as disabledsql

# from VictoriaBot.modules.sql import cust_filters_sql as filtersql
# import VictoriaBot.modules.sql.welcome_sql as welcsql
import VictoriaBot.modules.sql.locks_sql as locksql
from VictoriaBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("VictoriaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("VictoriaBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `VictoriaBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("VictoriaBot{}.backup".format(chat_id))  # Cleaning file

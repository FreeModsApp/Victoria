...
import VictoriaBot.modules.sql.global_bans_sql as gban_sql
import VictoriaBot.modules.sql.users_sql as user_sql
from VictoriaBot import DEV_USERS, OWNER_ID, dispatcher

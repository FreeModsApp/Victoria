...
from VictoriaBot import pbot as Jebot
from VictoriaBot.pyrogramee.dark import get_arg
...
@Victoria.on_message(filters.command("deezer"))
...
import aiohttp
from pyrogram import filters
from VictoriaBot import pbot as ASUNA

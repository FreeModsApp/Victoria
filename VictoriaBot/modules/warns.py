...
import telegram
from VictoriaBot import TIGERS, WOLVES, dispatcher
from VictoriaBot.modules.disable import DisableAbleCommandHandler
from VictoriaBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from VictoriaBot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from VictoriaBot.modules.helper_funcs.string_handling import split_quotes
from VictoriaBot.modules.log_channel import loggable
from VictoriaBot.modules.sql import warns_sql as sql
